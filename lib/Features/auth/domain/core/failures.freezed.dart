...
class _$ValueFailureTearOff {
  ...
  InvalidPassword<T> invalidPassword<T>({required String faildValue}) {
...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String faildValue) invalidPassword,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(String faildValue)? invalidPassword,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$InvalidPassword<T> implements InvalidPassword<T> {
  const _$InvalidPassword({required this.faildValue});
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.invalidPassword(faildValue: $faildValue)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return invalidPassword(faildValue);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return invalidPassword?.call(faildValue);
  }
...
abstract class InvalidPassword<T> implements ValueFailure<T> {
  const factory InvalidPassword({required String faildValue}) =
      _$InvalidPassword<T>;
