...
/// @nodoc
class _$TeacherValueFailureTearOff {
  const _$TeacherValueFailureTearOff();
...
/// @nodoc
const $TeacherValueFailure = _$TeacherValueFailureTearOff();

/// @nodoc
mixin _$TeacherValueFailure<T> {
  ...
  @JsonKey(ignore: true)
  $TeacherValueFailureCopyWith<T, TeacherValueFailure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TeacherValueFailureCopyWith<T, $Res> {
  factory $TeacherValueFailureCopyWith(TeacherValueFailure<T> value,
          $Res Function(TeacherValueFailure<T>) then) =
      _$TeacherValueFailureCopyWithImpl<T, $Res>;
  $Res call({String failValue});
}

/// @nodoc
class _$TeacherValueFailureCopyWithImpl<T, $Res>
    implements $TeacherValueFailureCopyWith<T, $Res> {
  _$TeacherValueFailureCopyWithImpl(this._value, this._then);

  final TeacherValueFailure<T> _value;
  // ignore: unused_field
  final $Res Function(TeacherValueFailure<T>) _then;
...
class _$EmptyFieldCopyWithImpl<T, $Res>
    extends _$TeacherValueFailureCopyWithImpl<T, $Res>
...
class _$EmptyField<T> implements EmptyField<T> {
  ...
  @override
  String toString() {
    return 'TeacherValueFailure<$T>.isEmptyField(failValue: $failValue)';
  }
...
abstract class EmptyField<T> implements TeacherValueFailure<T> {
